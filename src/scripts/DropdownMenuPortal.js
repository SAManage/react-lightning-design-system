...
class DropdownMenuPortal extends Component {
  onMenuItemBlur(e) {
    if (this.props.onBlur) {
      this.props.onBlur(e);
    }
  ...
  render() {
    const {
      className, align, vertAlign, size, header, nubbinTop, hoverPopup, children,
      dropdownMenuRef,
      onFocus, onBlur, portalLeft,
    } = this.props;
...
DropdownMenuPortal.propTypes = {
  ...
  nubbin: PropTypes.oneOf(['top', 'top left', 'top right', 'bottom', 'bottom left',
    'bottom right', 'auto']),
