...
export default class DropdownButtonPortal extends Component {
  constructor() {
    super();
  ...
  render() {
    const {
      ...
      label, children, menuClassName, portalLeft, ...props,
      } = this.props;
    let { icon } = this.props;
...
DropdownButtonPortal.propTypes = {
